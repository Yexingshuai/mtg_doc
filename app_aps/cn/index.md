...
App-ads.txt 是开发者向DSP提供其APP广告资源的授权销售商列表。IAB创建了这个系统，开发者使用该文件来指定其广告资源的授权销售商，而DSP使用该文件来验证他们购买的是否是经过授权的广告资源。开发者将此文件托管在其网站的根域中，在Google Play Store 或 Apple App Store中提供该网站地址，DSP会扫描该文件中销售商的id与请求中的id是否对应，以此来避免广告欺诈行为。大多数DSP平台将不会购买未实现ads.txt的广告资源。 为了保障您的收益，建议您跟随下方指引完成该项内容。

您可以在这里了解更多关于App-Ads.txt 的内容[https://iabtechlab.com/ads-txt](https://iabtechlab.com/ads-txt/)

## App-Ads.txt 实施指南

**1、确保在Google Play和App Store应用程序页面上标记您的网站。**       
广告平台将通过此网站来验证app-ads.txt文件。

**2、 创建App-Ads.txt文件**      
根据IAB提供的结构，将您的授权方信息整理在该文件中。每个授权方占一行。

**Ad Source Domain**: 广告来源域名。如Mintegral，域名为mintegral.com

**Publisher ID**: 发布者id，您可以在Mintegral后台【账户管理】>【账户信息】找到自己的Publisher ID

**Type of Relationship**: 您的直接需求合作伙伴应列为“DIRECT”。如果你的广告平台使用第三方reseller来售卖你的流量，该平台应该被标记为“RESELLER”

**Ad Source ID**:  广告来源的ID. Mintegral的ad source id为 0aeed750c80d6423

**example：mintegral.com, XXXX, DIRECT, 0aeed750c80d6423**

**3、将app-ads.txt放到您网站的根域下**

如：www.example.com/app-ads.txt

## Mintegral 授权经销商

请将<font color='red'> your PublisherID </font>替换为您自己的publisher id
