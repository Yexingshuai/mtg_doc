...
As part of a broader effort to eliminate the ability to profit from counterfeit inventory, Ads.txt provides a mechanism to enable content owners to declare who is authorized to sell their inventory. Please post the App-Ads.txt file to the root directory of your website, and provide your website URL on Google Play Store / Apple App Store. As a considerable percentage of DSPs will not buy any inventory that failed for App-Ads.txt validation, we strongly suggest you to implement the App-Ads.txt items following instructions below.

Learn More about App-Ads.txt[https://iabtechlab.com/ads-txt](https://iabtechlab.com/ads-txt/)

## App-Ads.txt Implementation Guidance

**1. Provide developer website URL in app store listings**       
Using this website URL, Mintegral crawlers will derive a path and attempt to crawl an App-Ads.txt file on the corresponding domain. 

**2. Create an App-Ads.txt file**      
Post all authorized seller info below in the App-Ads.txt file accordingly. Each item should be placed in a new line.

**Ad Source Domain**: The canonical domain name of the SSP, Exchange, Header Wrapper, etc system that bidders connect to. Eg. mintegral.com for Mintegral

**Publisher ID**: You may find your Mintegral publisher ID in Mintegral dashboard in section Account-Account Info.

**Type of Relationship**: A value of 'DIRECT' indicates that the Publisher (content owner) directly controls the account indicated in Publisher ID on the system in Ad Source Domain. This tends to mean a direct business contract between the Publisher and the advertising system. A value of 'RESELLER' indicates that the Publisher has authorized another entity to control the account indicated in Publisher ID and resell their ad space via the system in Ad Source Domain.

**Certification Authority ID**:  Optional) An ID that uniquely identifies the 
advertising system within a certification authority. Eg. Mintegral's ID is 0aeed750c80d6423

**Example：mintegral.com, XXXX, DIRECT, 0aeed750c80d6423**

**3. Post the App-Ads.txt file**

Post the App-Ads.txt file to the corresponding path. Eg. www.mintegral.com/app-ads.txt

## Mintegral Authorized Sellers

Please replace<font color='red'> your PublisherID </font>with your actual publisher id acquired from Mintegral dashboard.
